...
typedef struct _BMP_Header
{
	...
	UINT		DataOffset;			/* Offset of image data relative to the file's start 相对于文件开始的图像数据偏移 */
	...
	USHORT		BitsPerPixel;		/* Number of bits per pixel 每像素位数 */
	UINT		CompressionType;	/* Compression type 压缩类型*/
	UINT		ImageDataSize;		/* Size of uncompressed image's data */
	UINT		HPixelsPerMeter;	/* Horizontal resolution (pixels per meter) 水平分辨率（每米像素）*/
...
/**************************************************************
	...
	and bit depth.创建具有指定尺寸和位深度的空白BMP图像。
**************************************************************/
BMP* BMP_Create( UINT width, UINT height, USHORT depth )
{
	...
	/* Allocate the bitmap data structure 分配位图数据结构*/
...
/**************************************************************
	Reads the specified BMP image file.读取指定的BMP图像文件。
**************************************************************/
...
/**************************************************************
	Returns the image's color depth (bits per pixel). 返回图像的颜色深度（每像素位数）。
**************************************************************/
...
void BMP_GetPixelRGB( BMP* bmp, UINT x, UINT y, UCHAR* r, UCHAR* g, UCHAR* b )
{
	...
	else
	{
		...
		/* Calculate the location of the relevant pixel (rows are flipped) 计算相关像素的位置（行被翻转）*/
...
/**************************************************************
	Sets the specified pixel's RGB values. 设置指定像素的RGB值。
**************************************************************/
...
/**************************************************************
	Gets the color value for the specified palette index.获取指定调色板索引的颜色值。
**************************************************************/
